...
#'
#' - **`chi_year`**: Birth year, randomly reassigned while preserving the
#'   empirical distribution
#' - **`chi_age`**: Maternal age, randomly reassigned while preserving the
#'   empirical distribution
#' - **`chi_geo_kc`**: A King County, WA specific indicator, randomly assigned
#'   as `"King County"` or `NA`
#' - **`chi_sex`**: Infant sex, randomly reassigned while preserving the
#'   empirical distribution
#' - **`race4`**: OMB race/ethnicity, with Hispanic as a race, randomly
#'   reassigned while preserving the empirical distribution
#' - **`birth_weight_grams`**: The recorded birth weight in grams
#' - **`preterm`**: Binary flag for preterm delivery
#' - **`fetal_pres`**: Fetal presentation (Breech, Cephalic, or Other)
#' - **`kotelchuck`**: Binary flag for early and adequate prenatal care, as
#' measured by the Kotelchuck index
#' - **`mother_birthplace_state`**: Mother's birthplace state, randomly
#'   reassigned while preserving the empirical distribution
...
#' and development. This privacy-safe dataset contains cause of death (ICD-10),
