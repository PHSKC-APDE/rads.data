...
#'
#' - [A Brief Introduction to ICD-10-CM Codes](https://github.com/PHSKC-APDE/rads.data/wiki/ICD-10-CM)
#'
#' @examples
...
#'
#' @references
#' - [A Brief Introduction to ICD-10 Death Codes](https://github.com/PHSKC-APDE/rads.data/wiki/ICD-10)
#' - [ICD-10 Cause-of-Death Lists for Tabulating Mortality  Statistics](https://www.cdc.gov/nchs/data/dvs/Part9InstructionManual2020-508.pdf)
#'
...
#' [ICD-10 Cause-of-Death Lists for Tabulating Mortality  Statistics](https://www.cdc.gov/nchs/data/dvs/Part9InstructionManual2020-508.pdf), on pages 18-20.
#'
#' @references
#' - [A Brief Introduction to ICD-10 Death Codes](https://github.com/PHSKC-APDE/rads.data/wiki/ICD-10)
#' - [ICD-10 Cause-of-Death Lists for Tabulating Mortality  Statistics](https://www.cdc.gov/nchs/data/dvs/Part9InstructionManual2020-508.pdf)
...
#' @references
#' - [A Brief Introduction to ICD-10 Death Codes](https://github.com/PHSKC-APDE/rads.data/wiki/ICD-10)
#' - [WA DOH CHAT (User Guides >> Definition of "Special Code Sets")](https://secureaccess.wa.gov/doh/chat/Entry.mvc)
#' - [National Vital Statistics Reports, Vol 70, No. 8](https://www.cdc.gov/nchs/data/nvsr/nvsr70/nvsr70-08-508.pdf)
#'
...
#' [Clinical Classifications Software Refined (CCSR)](https://hcup-us.ahrq.gov/toolssoftware/ccsr/ccs_refined.jsp)
#' categories used by
#' Public Health – Seattle & King County for analyzing diagnosis patterns in
...
#'
#' @details
#' The [Clinical Classifications Software Refined (CCSR)](https://hcup-us.ahrq.gov/toolssoftware/ccsr/ccs_refined.jsp)
#' is a diagnosis and
#' procedure categorization scheme developed by AHRQ's Healthcare Cost and
...
#'
#' **Note:** This dataset should be refreshed at minimum on an annual basis to
#' reflect any changes in CCSR definitions or APDE categorizations. This typically
#' occurs in September or October and is dependent upon the update of `[ref].[icdcm_codes]`
#' in HHSAW.
#'
#' @source
#' Generated by [rads.internal::make_chars_icd_ccs()].
...
#' because they are not included in the coding used by WA DOH.
#'
...
#' @references
#' - [A Brief Introduction to ICD-10 Death Codes](https://github.com/PHSKC-APDE/rads.data/wiki/ICD-10)
#' - [CDC: External Cause of Injury Mortality Matrix](https://www.cdc.gov/nchs/injury/ice/matrix10.htm)
#'
...
#' @references
#'
#' `icd10pcsOrderFile.pdf` in <https://www.cms.gov/files/zip/2022-icd-10-pcs-codes-file-updated-december-1-2021.zip>
#'
...
# synthetic_birth ----
#' Synthetic Birth Data for Testing and Development
#'
#' @description
#' A synthetic dataset derived from real 2019-2023 birth data for use in
...
#'
#' @source
#' Generated by [rads.internal::make_synthetic_birth()].
#'
#' @examples
#' library(data.table)
#'
#' # Load the synthetic birth data
#' data(synthetic_birth)
#'
#' # View structure
#' str(synthetic_birth)
#'
#' # Check the distribution of infant sex
#' table(synthetic_birth$chi_sex)
#'
#' @keywords datasets
"synthetic_birth"
...
# synthetic_death ----
#' Synthetic Death Data for Testing and Development
#'
#' @description
#' A synthetic dataset derived from real death data for use in testing
#' and development.
#'
...
#'
#' @source
#' Generated by [rads.internal::make_synthetic_death()].
#'
#' @examples
#' library(data.table)
#'
#' # Load the synthetic CHARS data
#' data(synthetic_death)
#'
#' # View structure
#' str(synthetic_death)
#'
#' # Check the distribution of temperament
#' table(synthetic_death$temperament)
#'
#' @keywords datasets
"synthetic_death"

# synthetic_infdeath ----
#' Synthetic Infant Death Data for Testing and Development
#'
#' @description
#' A synthetic dataset derived from real death data for use in testing
#' and development.
#'
#' @format A data.table with 4 columns and more than 2,000 rows:
#'
#' - **`year`**: Year of death
#' - **`sex`**: Infant's sex
#' - **`underlying_cod_code`**: ICD-10 underlying cause of death code, cleaned via [rads::death_icd10_clean()]
#' - **`creation_date`**: A simple time stamp of the date the table was updated
#'
#' @source
#' Generated by [rads.internal::make_synthetic_infdeath()].
#'
#' @examples
#' library(data.table)
#'
#' # Load the synthetic CHARS data
#' data(synthetic_infdeath)
#'
#' # View structure
#' str(synthetic_infdeath)
#'
#' # Check the distribution of sex
#' table(synthetic_infdeath$sex)
#'
#' @keywords datasets
"synthetic_infdeath"

# synthetic_population ----
#' Synthetic Population Data for Testing and Development
#'
#' @description
...
#'
#' @source
#' Generated by [rads.internal::make_synthetic_population()].
#'
#' @examples
#' library(data.table)
#'
...
# synthetic_survey ----
#' Synthetic Survey (PUMS) Data for Testing and Development
#'
#' @description
#' A synthetic dataset derived from real American Community Survey (ACS)
#' Public Use Microdata Sample (PUMS) data for use in testing and
#' development. Unlike the other `synthetic_*` tables, this dataset is not
#' randomly resampled or reassigned, since PUMS microdata is already a
#' public, de-identified survey product -- so it is not truly 'synthetic.'
#'
#' @format A data.table with 385 columns and more than 100,000 rows:
#'
#' - All columns returned by [apde.data::pums()] for the 2020-2024 5-year
#'   estimates, excluding the internal `_Id` identifier column added during
#'   survey design
#' - **`creation_date`**: A simple time stamp of the date the table was updated
#'
#' @source
#' Generated by [rads.internal::make_synthetic_survey()].
#'
#' @examples
#' library(data.table)
#'
