...
#'
#' @format A data.table with 42 columns and more than 250,000 rows:
#'
#' **Diagnosis and Classification:**
#' - **`diag1`:** Primary diagnosis code (character)
#' - **`injury_intent`:** Injury intent classification (character)
#' - **`injury_mechanism`:** Injury mechanism classification (character)
#' - **`injury_nature_narrow`:** Narrow injury nature category (character)
#' - **`injury_nature_broad`:** Broad injury nature category (character)
#'
#' **Intent Indicators (logical):**
#' - **`intent_assault`:** Assault-related injury indicator
#' - **`intent_intentional`:** Intentional injury indicator
#' - **`intent_legal`:** Legal intervention-related injury indicator
#' - **`intent_undetermined`:** Undetermined intent indicator
#' - **`intent_unintentional`:** Unintentional injury indicator
#' - **`intent_any`:** Any intent indicator
#'
#' **Mechanism Indicators (logical):**
#' - **`mechanism_bites_stings`:** Bites and stings indicator
#' - **`mechanism_cut_pierce`:** Cut/pierce injury indicator
#' - **`mechanism_drowning`:** Drowning indicator
#' - **`mechanism_fall`:** Fall-related injury indicator
#' - **`mechanism_fire_burn`:** Fire/burn injury indicator
#' - **`mechanism_firearm`:** Firearm-related injury indicator
#' - **`mechanism_machinery`:** Machinery-related injury indicator
#' - **`mechanism_motor_vehicle_nontraffic`:** Non-traffic motor vehicle indicator
#' - **`mechanism_mvt_motorcyclist`:** Motor vehicle traffic - motorcyclist
#' - **`mechanism_mvt_occupant`:** Motor vehicle traffic - occupant
#' - **`mechanism_mvt_other`:** Motor vehicle traffic - other
#' - **`mechanism_mvt_pedal_cyclist`:** Motor vehicle traffic - pedal cyclist
#' - **`mechanism_mvt_pedestrian`:** Motor vehicle traffic - pedestrian
#' - **`mechanism_mvt_unspecified`:** Motor vehicle traffic - unspecified
#' - **`mechanism_natural_environmental`:** Natural/environmental injury indicator
#' - **`mechanism_other_land_transport`:** Other land transport indicator
#' - **`mechanism_other_specified`:** Other specified mechanism indicator
#' - **`mechanism_other_transport`:** Other transport indicator
#' - **`mechanism_overexertion`:** Overexertion indicator
#' - **`mechanism_pedal_cyclist`:** Pedal cyclist indicator
#' - **`mechanism_pedestrian`:** Pedestrian indicator
#' - **`mechanism_poisoning`:** Poisoning indicator
#' - **`mechanism_poisoning_drug`:** Drug poisoning indicator
#' - **`mechanism_poisoning_nondrug`:** Non-drug poisoning indicator
#' - **`mechanism_struck_by_against`:** Struck by/against indicator
#' - **`mechanism_suffocation`:** Suffocation indicator
#' - **`mechanism_unspecified`:** Unspecified mechanism indicator
#' - **`mechanism_any`:** Any mechanism indicator
#'
#' **Synthetic Identifiers:**
#' - **`seq_no`:** Unique sequence number identifier (integer)
#' - **`temperament`:** Random categorical indicator with values "Calm",
#'   "Moderate", or "Active" (character)
#'
#' **Metadata:**
#' - **`creation_date`:** Date this dataset was last updated (Date)
#'
#' @source
...
#'
#' # Examine fall-related injuries
#' synthetic_chars[mechanism_fall == 1,
#'                 list(seq_no, injury_intent, injury_mechanism)]
#'
#' @keywords datasets
"synthetic_chars"
